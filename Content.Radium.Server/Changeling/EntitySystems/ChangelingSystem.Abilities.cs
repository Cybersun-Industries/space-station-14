...
using Content.Radium.Shared.Changeling;
...
using HarvestEvent = Content.Radium.Shared.Changeling.HarvestEvent;

// This one has parts of Goob Station's code. (https://github.com/Goob-Station/Goob-Station/blob/dd4a7d37ab35ba8c2bbd6dfa72332916ad8805ab/Content.Server/Goobstation/Changeling/ChangelingSystem.cs)
...
public sealed partial class ChangelingSystem
{
    ...
    [Dependency] private readonly FlashSystem _flash = null!;
    [Dependency] private readonly DamageableSystem _damageSystem = null!;
    [Dependency] private readonly SurgerySystem _surgerySystem = null!;
    [Dependency] private readonly InventorySystem _inventorySystem = null!;
    ...
    [Dependency] private readonly HandsSystem _handsSystem = null!;
    [Dependency] private readonly SharedCameraRecoilSystem _recoil = null!;
    [Dependency] private readonly SharedAudioSystem _audio = null!;
    [Dependency] private readonly SharedTransformSystem _transform = null!;
    [Dependency] private readonly EmpSystem _emp = null!;
    [Dependency] private readonly EntityLookupSystem _lookup = null!;
    [Dependency] private readonly PoweredLightSystem _poweredLight = null!;
    ...
    [Dependency] private readonly StatusEffectsSystem _statusEffect = null!;
    [Dependency] private readonly CuffableSystem _cuffable = null!;
    [Dependency] private readonly PuddleSystem _puddle = null!;
    [Dependency] private readonly PullingSystem _pullingSystem = null!;
    ...
    private void OnDnaStingEventAction(EntityUid uid, ChangelingComponent component, ActionChangelingDnaStingEvent args)
    {
        ...
        if (dna.IsExtracted)
        {
            _popup.PopupEntity(Loc.GetString("changeling-absorb-fail-absorbed"),
                uid,
        ...
        _popup.PopupEntity(Loc.GetString("changeling-absorb-end-self"),
            uid,
            uid,
            PopupType.Medium);
    ...
    private void OnAbsorbDNAAction(EntityUid uid, ChangelingComponent component, ChangelingAbsorbDnaActionEvent args)
    {
        ...
        {
            _popup.PopupEntity(Loc.GetString("changeling-absorb-fail-incapacitated"), uid);
            return;
        }
        ...
        EntityUid target)
    {
        ...
        _popup.PopupEntity(Loc.GetString("changeling-absorb-start"),
            target,
