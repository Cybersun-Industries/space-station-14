...
public sealed partial class ChangelingSystem : EntitySystem
{
    ...
    [Dependency] private readonly ActionsSystem _action = null!;
    ...
    [Dependency] private readonly RoleSystem _roles = null!;
    [Dependency] private readonly IPlayerManager _playerManager = null!;
    [Dependency] private readonly IServerConsoleHost _console = null!;
    [Dependency] private readonly UserInterfaceSystem _userInterface = null!;
    [Dependency] private readonly ActorSystem _actors = null!;
    ...
    [Dependency] private readonly NpcFactionSystem _npcFaction = null!;
    ...
    private (EntityUid stealerUid, HumanoidCharacterProfile pref) SpawnChangeling(EntityCoordinates coords)
    {
        ...
        if (_prototype.TryIndex(spawnJob.StartingGear!, out var gear))
        {
