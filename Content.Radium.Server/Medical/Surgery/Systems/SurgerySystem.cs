...
public sealed partial class SurgerySystem : EntitySystem
{
    ...
    [Dependency] private readonly IDynamicTypeFactory _dynamicTypeFactory = null!;
    ...
    [Dependency] private readonly ServerDamagePartsSystem _damageParts = null!;
    [Dependency] private readonly DrunkSystem _drunkSystem = null!;
    [Dependency] private readonly SharedSolutionContainerSystem _solutionContainerSystem = null!;
    [Dependency] private readonly StutteringSystem _stutteringSystem = null!;
    [Dependency] private readonly PuddleSystem _puddleSystem = null!;
    [Dependency] private readonly ForensicsSystem _forensicsSystem = null!;
    ...
    [Dependency] private readonly BuckleSystem _buckleSystem = null!;
            ...
            foreach (var pair in a)
            {
                ...
                switch (pair.Key.Item1)
                {
                    ...
                    case BodyPartType.Leg:
                        ...
                        var diffSymmetry = part.Value.Component.Symmetry switch
                        {
        ...
        if (surgery.CurrentStep != null)
        {
            ...
            if (action is SurgeryTypeEnum.AddPart or SurgeryTypeEnum.AddAdditionalPart)
            {
                if (args.Used != null)
                {
                    var type = _reflectionManager.LooseGetType(surgeryOperationPrototype.EventKey);
                    var ev = _dynamicTypeFactory.CreateInstance(type,
                        [uid, surgeryOperationPrototype.ID, component.Symmetry, args.Used]);
                    RaiseLocalEvent(ev);
                }
            }
        }
