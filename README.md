...
> **NOTE**:
>
> This repository is archived from 24.08.2025. <br /><br />
...
На сайте GoobStation с [документацией](https://docs.goobstation.com/) имеется вся необходимая информация о контенте SS14, движке, дизайне игры и многом другом. Также имеется много информации для начинающих разработчиков.
...
>[!CAUTION]
>
> Весь код репозитория выпускается под AGPL-3.0-or-later лицензией. Каждый файл включает REUSE заголовки или отдельные .license файлы, которые содержат двойную лицензию. Двойная лицензия предоставляется для упрощения процесса для проектов, которые не используют AGPL, позволяя им встраивать соответствующие части кода под другой лицензией. Вы можете прочитать полные тексты этих лицензий в LICENSES/ директории.
