...
>[!CAUTION]
>
> Контент, внесённый в этот репозиторий после коммита fc9a78f2ccb5faef6ff38cef5321068b02bdc972, лицензируется как под AGPLv3, так и под CLA - это касается наших изменений, определение которых дано в тексте CLA, если не указано иное. ```См. LICENSE-AGPLv3.txt и CLA.txt```. Изменения, внесенные в этот репозиторий до коммита fc9a78f2ccb5faef6ff38cef5321068b02bdc972, лицензируется под MIT, если не указано иное. См. ```LICENSE-MIT.txt```.
