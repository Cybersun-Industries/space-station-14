...
public abstract class SharedVoidCurseSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<VoidCurseComponent, OnTemperatureChangeEvent.TemperatureChangeAttemptEvent>(OnTemperatureChangeAttempt);
    ...
    private void OnTemperatureChangeAttempt(Entity<VoidCurseComponent> ent, ref OnTemperatureChangeEvent.TemperatureChangeAttemptEvent args)
    {
