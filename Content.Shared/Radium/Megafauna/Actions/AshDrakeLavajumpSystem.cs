...
/// <summary>
/// This handles making entities perform a lava jump when the Ash Drake action is triggered.
/// </summary>
public sealed class AshDrakeLavajumpSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<AshDrakeLavajumpAction>(OnJumpAction);
        SubscribeLocalEvent<AshDrakeLavajumpingComponent, UpdateCanMoveEvent>(OnUpdateCanMove);
    }

    private void OnJumpAction(AshDrakeLavajumpAction args)
    {
    ...
    private void StartLavajump(EntityUid performer, EntityCoordinates coords, bool playSound = true)
    {
        ...
        _blocker.UpdateCanMove(performer);
...
/*        if (playSound)
            ...
            () =>
        {
            ...
            RemComp<AshDrakeLavajumpingComponent>(performer);
            _blocker.UpdateCanMove(performer);
        });
    }

    private void OnUpdateCanMove(EntityUid uid, AshDrakeLavajumpingComponent component, UpdateCanMoveEvent args)
    {
        args.Cancel();
    }
}
