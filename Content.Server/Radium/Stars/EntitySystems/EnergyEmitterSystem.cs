...
namespace Content.Server.Radium.Stars.EntitySystems
{
public sealed class EnergyEmitterSystem : EntitySystem
{
    ...
    [Dependency] private readonly GunSystem _gun = default!;
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<EnergyEmitterComponent, PowerConsumerReceivedChanged>(ReceivedChanged);
            SubscribeLocalEvent<EnergyEmitterComponent, PowerChangedEvent>(OnApcChanged);
            SubscribeLocalEvent<EnergyEmitterComponent, InteractHandEvent>(OnInteractHand);
            SubscribeLocalEvent<EnergyEmitterComponent, GetVerbsEvent<Verb>>(OnGetVerb);
            SubscribeLocalEvent<EnergyEmitterComponent, ExaminedEvent>(OnExamined);
            SubscribeLocalEvent<EnergyEmitterComponent, AnchorStateChangedEvent>(OnAnchorStateChanged);
            SubscribeLocalEvent<EnergyEmitterComponent, SignalReceivedEvent>(OnSignalReceived);
        }

        private void OnAnchorStateChanged(EntityUid uid, EnergyEmitterComponent component, ref AnchorStateChangedEvent args)
        {
            if (args.Anchored)
                return;
        ...
        private void OnInteractHand(EntityUid uid, EnergyEmitterComponent component, InteractHandEvent args)
        {
            if (args.Handled)
                return;
        ...
        private void OnGetVerb(EntityUid uid, EnergyEmitterComponent component, GetVerbsEvent<Verb> args)
        {
        ...
        private void OnExamined(EntityUid uid, EnergyEmitterComponent component, ExaminedEvent args)
        {
            if (component.SelectableTypes.Count < 2)
                return;
        ...
        private void ReceivedChanged(
            EntityUid uid,
            EnergyEmitterComponent component,
        ...
        private void OnApcChanged(EntityUid uid, EnergyEmitterComponent component, ref PowerChangedEvent args)
        {
            if (!component.IsOn)
            {
                return;
        ...
        public void SwitchOff(EntityUid uid, EnergyEmitterComponent component)
        {
        ...
        public void SwitchOn(EntityUid uid, EnergyEmitterComponent component)
        {
            component.IsOn = true;
            if (TryComp<PowerConsumerComponent>(uid, out var powerConsumer))
        ...
        public void PowerOff(EntityUid uid, EnergyEmitterComponent component)
        {
        ...
        public void PowerOn(EntityUid uid, EnergyEmitterComponent component)
        {
            if (component.IsPowered)
            {
                return;
        ...
        private void ShotTimerCallback(EntityUid uid, EnergyEmitterComponent component)
        {
        ...
        private void Fire(EntityUid uid, EnergyEmitterComponent component)
        {
        ...
        private void UpdateAppearance(EntityUid uid, EnergyEmitterComponent component)
        {
            EnergyEmitterVisualState state;
            if (component.IsPowered)
            {
                state = EnergyEmitterVisualState.On;
            }
            else if (component.IsOn)
            {
                state = EnergyEmitterVisualState.Underpowered;
            }
            else
            {
                state = EnergyEmitterVisualState.Off;
            }
            _appearance.SetData(uid, EnergyEmitterVisuals.VisualState, state);
        }

        private void OnSignalReceived(EntityUid uid, EnergyEmitterComponent component, ref SignalReceivedEvent args)
        {
