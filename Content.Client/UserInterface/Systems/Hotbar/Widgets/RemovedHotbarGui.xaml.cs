using Content.Client.Radium.UserInterface.Systems.Hotbar;
...
public sealed partial class RemovedHotbarGui : UIWidget //RADIUM: REVERT HAND STATE SYSTEM; DO NOT MERGE.
{
    public RemovedHotbarGui()
    {
