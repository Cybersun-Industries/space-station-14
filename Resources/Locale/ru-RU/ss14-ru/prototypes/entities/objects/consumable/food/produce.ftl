...
ent-FoodWorldPeas = мировой горох
    .desc = Несет счастье и мир!
ent-FoodExtradimensionalOrange = экстраизмеренческий апельсин
    .desc = За гранью вашего понимания.
ent-FoodHolymelon = святой арбуз
    .desc = У него нимб.
ent-MeatwheatBushel = мясная пшеница
    .desc = Странное растение, смесь флоры и фауны.
ent-FoodAnomalyBerry = аномальная ягода
    .desc = Будьте аккуратны, употребляя это.