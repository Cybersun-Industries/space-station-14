...
ent-SecurityTechFabCircuitboard = СБФаб (машинная плата)
    .desc = Печатная плата охранного ТехФаба.
ent-AmmoTechFabCircuitboard = ПатронФаб (машинная плата)
    .desc = Печатная плата ТехФаба патронов.
ent-MedicalTechFabCircuitboard = МедФаб (машинная плата)
