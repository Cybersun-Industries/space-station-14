...
ent-ComputerCargoOrdersEngineering = консоль инженерных заказов
    .desc = Используется для заказа грузов инженерным отделом
ent-ComputerCargoOrdersMedical = консоль медицинских заказов
    .desc = Используется для заказа грузов медицинским отделом
ent-ComputerCargoOrdersScience = консоль научных заказов
    .desc = Используется для заказа грузов научным отделом
ent-ComputerCargoOrdersSecurity = консоль СБ заказов
    .desc = Используется для заказа грузов СБ
ent-ComputerCargoOrdersService = консоль сервисных заказов
    .desc = Используется для заказа грузов сервисным отделом.
ent-ComputerCargoOrders = консоль заказа грузов
    .desc = Используется для оформления запросов и одобрения заказов.
ent-ComputerFundingAllocation = консоль распределения бюджета
    .desc = Терминал контроля денежных средств каждого отдела.
ent-ComputerCargoBounty = консоль запросов
    .desc = Используется для управления текущими активными запросами.
ent-ComputerSalvageJobBoard = консоль утилизации
    .desc = Консоль для утилизациионых работ
