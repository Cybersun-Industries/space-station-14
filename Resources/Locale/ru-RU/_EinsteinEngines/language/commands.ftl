...
command-saylang-desc = Отправлет сообщение на указанном языке. Вы можете использовать как название языка, так и его позицию в списке.
...
command-description-language-lsunderstood = Lists all languages the entity can understand. Пример: 'self language:lssunderstood'
...
command-description-translator-lsunderstood = Lists all understood languages for the piped translator entity. Пример: 'ent 1234 translator:lssunderstood'
